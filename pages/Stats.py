...
genai.configure(api_key="AIzaSyD-uiJVMsn9QzWR8Au7_Cny1apySCvdXWY")
...
convo = model.start_chat(history=[
  ...
  },
  {
   ...
   {
    "role": "user",
    "parts": ["price of oxgasless"]
  },
  {
    "role": "model",
    "parts": ["function_call,price\\_of\\_crypto,0xgasless"]
  },
  {
    "role": "user",
    "parts": ["hi"]
